			...
			<form role="form" id='quiz_form' method="post" action="quiz-result.php">
				...
				<div class="panel panel-primary">
					<div class="panel-heading clearfix question-text"> 
						<div class="panel-title">Static VLANs "Marketing, Sale, Accouting and Engineering" are configured in Switch-A and Switch-B. Each VLAN contains 12 hosts. Assumming that all VLANs communicate together, how many subnets must be routed?</div> 
					...
					<div class="panel-body panel-text"> 
						...
						<div class="radio radio-replace radio-success">
							...
							<label for="radio7">Success</laquestion-textbel>
						</div>
